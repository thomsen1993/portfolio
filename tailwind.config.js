    ...
    extend: {
      ...
      keyframes: {
        ...
        throw: {
          ...
          '22%': { transform: 'translateY(-100px) scale(1.9)' },
          '25%': { transform: 'translateY(-100px) scale(2)' },
          '30%': { transform: 'translateY(-100px) scale(1.9)' },
          '35%': { transform: 'translateY(-100px) scale(2)' },
